...
void DatumToCVMat3Channels(const Datum& datum, cv::Mat* cv_img);
void DatumDataToCVMat3Channels(const string& data, const int channels, const int height, const int width, cv::Mat* cv_img);
#endif  // USE_OPENCV
